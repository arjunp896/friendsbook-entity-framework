...
angular.module("ui.checkbox", []).directive("checkbox", function() {
	return {
		...
		restrict: "E",
		replace: "true",
		template: "<button type=\"button\" ng-style=\"stylebtn\" class=\"btn btn-default\" ng-class=\"{'selected-checkbox': checked===true, 'btn-xs': size==='default', 'btn-sm': size==='large', 'btn-lg': size==='largest'}\">" +
...
angular.module("ui.multiselect", ["multiselect.tpl.html"])
	...
	.directive("multiselect", ["$parse", "$document", "$compile", "$interpolate", "optionParser", function($parse, $document, $compile, $interpolate, optionParser, $scope) {
		return {
			restrict: "E",
			require : "ngModel",
			link    : function(originalScope, element, attrs, modelCtrl) {
				...
				var isBilling = attrs.billing ? true : false;
				var required = false;
				...
				function getHeaderText() {
					if(isEmpty(modelCtrl.$modelValue)) {
						scope.header = scope.billing == true ? "No Credit Card Selected" :  attrs.msHeader || "Select";
						scope.classSelect = "no";
						return scope.header;
					}
...
angular.module("multiselect.tpl.html", []).run(["$templateCache", function($templateCache) {
	...
	$templateCache.put("multiselect.tpl.html",
			"<div class=\"btn-group\">\n" +
			"  <button type=\"button\" class=\"btn btn-default dropdown-toggle multiselect-{{ classSelect }}\" ng-click=\"toggleSelect()\" ng-disabled=\"disabled\" ng-class=\"{'error': !valid()}\">\n" +
			"    {{header}}<span class=\"caret\"></span>\n" +
			"  </button>\n" +
			"  <ul class=\"dropdown-menu\" style=\"margin-bottom:30px;\">\n" +
			"    <li data-stopPropagation=\"true\" ng-repeat=\"i in items\" ng-hide=\"i.model.letter == '-1'\" >\n" +
